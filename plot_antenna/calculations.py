...
# Frequency extrapolation moved to plot_antenna/extrapolation.py (#38).
# Re-exported here so existing `from .calculations import extrapolate_pattern`
# / `validate_extrapolation` imports continue to work unchanged.
from .extrapolation import extrapolate_pattern, validate_extrapolation
